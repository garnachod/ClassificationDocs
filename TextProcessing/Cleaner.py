...
stopwords = {
    "en": {"a": True, "about": True, "above": True, "after": True, "again": True, "against": True, "all": True,
           ...
           "only": True, "or": True,
           "other": True, "ought": True, "our": True, "ours 	ourselves": True, "out": True, "over": True,
    ...
    "es": {"ni": True, "he": True, "os": True, "te": True, "al": True, "mi": True, "tu": True, "le": True, "se": True,
           ...
           "como": True, "en": True, "para": True, "atras": True, "porque": True, "por": True, "que": True,
...
class Cleaner(object):
    @staticmethod
    def clean(line, lang):
        line = Cleaner.cleanCharacters(line)
        line = Cleaner.stopWordsByLanguagefilter(line, lang)
        line = Cleaner.stemmingByLanguage(line, lang)

        return line

    @staticmethod
    def cleanCharacters(line):
        line = line.lower()
        line = line.replace("\n", ". ").replace("\r", ". ").replace(u"\u0085", ". ").replace(u"\u2028", ". ").replace(
            u"\u2029", ". ")
